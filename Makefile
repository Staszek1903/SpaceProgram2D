...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
	ifeq ($(PLATFORM_OS),WINDOWS)
		...
		CFLAGS += $(RAYLIB_PATH)/src/raylib.rc.data #-Wl,--subsystem,windows # UNCOMENT TO DISABLE CONSOLE WINDOW
	endif
	ifeq ($(PLATFORM_OS),LINUX)
...
$(OBJ_DIR)/%.o: $(SRC_DIR)/%.cpp
	$(CC) -c $< -o $@ $(CFLAGS) -g $(INCLUDE_PATHS) -D$(PLATFORM)
